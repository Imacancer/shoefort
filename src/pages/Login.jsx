      ...
      <div className="relative w-1/2 h-full flex flex-col">
        <div className="absolute top-[20%] left-[10%] flex flex-col">
          ...
          <p className="text-xl text-white font-normal">
            Register now and get a 50% off shoe discount
          </p>
        </div>
      ...
      <div className="w-1/2 h-full bg-[#f5f5f5] flex flex-col p-20 justify-between items-center">
        ...
        >
          <div className="w-full flex flex-col mb-2">
            <h3 className="text-3xl text-[#ea580c] font-semibold mb-2">
              Login
            </h3>
            <p className="text-base text-[#ea580c]  mb-2">
          ...
          <button
            ...
            className="w-full text-white my-2 font-semibold bg-[#ea580c] rounded-md p-4 text-center flex items-center justify-center cursor-pointer hover:bg-black transition duration-300"
          >
